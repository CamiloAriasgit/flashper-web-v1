                ...
                <div className="p-8 sm:p-12">
                    ...
                    <div className="text-center mb-10">
                        <h1 className="text-3xl text-slate-800 tracking-tight mb-2">
                            Únete a <span className="text-neutral-700 font-black tracking-tight italic">Flash</span><span className='text-cyan-600 font-black tracking-tight italic'>Per</span>
                        </h1>
                    ...
                    <form className="space-y-5">
                        ...
                        <p className="mt-8 flex text-slate-500 items-center justify-center text-sm">
